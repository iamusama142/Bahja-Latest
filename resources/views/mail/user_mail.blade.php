...
<body style=" font-family: 'Montserrat', sans-serif;text-transform:capitalize;">
            ...
            <div class="row">
				<div class="col-12">
                    ...
                    <div class="btm_total_area_table" style=" text-align: right;
                     font-family: 'Montserrat', sans-serif;">
                        <table style="  width: 100%;max-width: 260px;float: right;font-family: 'Montserrat', sans-serif;">
    ...
    <a class="BAcktoShopping" href="https://bahja-latest.theklozet.com/product-grids" style="border: 1px solid black; position:absolute; bottom:0 ; left:0; padding: 10px; background: black; color: white;" >
