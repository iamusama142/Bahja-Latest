...
@section('title','Bahja | Category Update')
                                            ...
                                            <form action="{{route('category.update',$category->id)}})}}" method="post">
                                                ...
                                                <div class="form-group english-lan">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        ...
                                                        <input type="text" class="form-control @error('title') error @enderror" name="title" id="Title" value="{{$category->title}}">
                                                ...
                                                <div class="form-group arabic-lan">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        ...
                                                        <input type="text" class="form-control @error('title_ar') error @enderror" name="title_ar" id="Title_ar" value="{{$category->title_ar}}">
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <input type="checkbox"  name="is_parent" class="custom-control-input" id="is_parent" value='{{$category->is_parent}}' {{(($category->is_parent==1)? 'checked' : '')}}>

                                                    <label class="custom-control-label" for="is_parent">Is Parent</label>

                                                </div>

                                                <div class="form-group {{(($category->is_parent==1) ? 'd-none' : '')}} mt-3" id='parent_cat_div' >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input id="thumbnail" class="form-control @error('photo') error @enderror" type="text" name="photo" value="{{$category->photo}}">
                                                ...
                                                <div class="form-control-wrap">
                                                    ...
                                                    <div class="form-control-select">
                                                        ...
                                                        <select class="form-control form-select-lg" id="default-06" name="category_show">
                                                            ...
                                                            <option value="yes" {{(($category->category_show=='yes')? 'selected' : '')}}>Yes</option>

                                                            <option value="no" {{(($category->category_show=='no')? 'selected' : '')}}>No</option>
