        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <h5 class="mt-5">Incomplete / Faulty Orders</h5>
                <div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tbody>
                  ...
                  <tr>
                    ...
                    @endif
                    <td><a href="{{route('order.show',$order->id)}}"><em class="icon ni ni-eye"></em></a>
                      <a href="{{route('order.edit',$order->id)}}"><em class="icon ni ni-edit"></em></a>
                      <a href="{{route('delete',$order->id)}}"><em class="icon ni ni-trash"></em></a></td>
                  </tr>
                  @endforeach
                 </tbody>
                </table>
