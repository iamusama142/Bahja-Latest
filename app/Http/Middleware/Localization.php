...
{
    public function __construct(\Illuminate\Support\Facades\App $app)
    {
        $this->app = $app;
    }
...

    {
        if (Session::has('locale')) {
            ...
            \Illuminate\Support\Facades\App::setLocale($current_locale); // set app localization with locale value session
